...
class Localization extends \AppBundle\Entity\Localization implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'geoLat', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'geoLng', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Localization' . "\0" . 'place');
        }
