 ...
 */
class LocalizationForJourneyPlace extends \AppBundle\Entity\LocalizationForJourneyPlace implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\LocalizationForJourneyPlace' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\LocalizationForJourneyPlace' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\LocalizationForJourneyPlace' . "\0" . 'localization', '' . "\0" . 'AppBundle\\Entity\\LocalizationForJourneyPlace' . "\0" . 'place');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LocalizationForJourneyPlace $proxy) {
